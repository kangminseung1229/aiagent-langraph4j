...
public class ConsultationEmbeddingService {
    ...
    public void embedAndStore(Long counselId) {
        // 1. RDB에서 상담 데이터 조회
        Consultation consultation = consultationRepository.findById(counselId)
            .orElseThrow();
...
[
    {
        content: "제목: 환불 요청\n내용: 환불 처리 방법",
        metadata: {counselId: 123, category: "환불"},
        similarity: 0.95
    },
    {
        content: "제목: 환불 정책\n내용: 환불 가능 기간",
        metadata: {counselId: 456, category: "정책"},
        similarity: 0.87
    },
    ...
]
